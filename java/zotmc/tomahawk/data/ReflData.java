...
public class ReflData {
	...
	public static class ClientRefls {
		...
		public static class SoundManagers {
			...
			addSound = Utils.findMethod(SoundManager.class, "addSound", "func_77372_a")
	...
	public static class EntityArrows {
		...
		X_TILE = Utils.findField(EntityArrow.class, "field_145791_d", "xTile", "field_70247_d"), // -, 164, 164
		Y_TILE = Utils.findField(EntityArrow.class, "field_145792_e", "yTile", "field_70248_e"), // -, 164, 164
		Z_TILE = Utils.findField(EntityArrow.class, "field_145789_f", "zTile", "field_70245_f"), // -, 164, 164
		TICKS_IN_GROUND = Utils.findField(EntityArrow.class, "ticksInGround", "field_70252_j"),
		TICKS_IN_AIR = Utils.findField(EntityArrow.class, "ticksInAir", "field_70257_an");
	}
	
	public static class EnchantmentHelpers {
		public static final Invokable<EnchantmentHelper, Void>
		applyEnchantmentModifier = Utils.findMethod(EnchantmentHelper.class, "applyEnchantmentModifier", "func_77518_a")
			.asInvokable(Utils.findClass(
		...
		public static class DamageIterators {
			...
			private final Class<?>
			type = Utils.findClass("net.minecraft.enchantment.EnchantmentHelper$DamageIterator");
	...
	REGISTRY_OBJECTS = Utils.findField(RegistrySimple.class, "registryObjects", "field_82596_a"),
	DISPENSE_BEHAVIOR_REGISTRY =
			Utils.findField(BlockDispenser.class, "dispenseBehaviorRegistry", "field_149943_a", "field_82527_a"), // -, -, 164
	SIN_TABLE = Utils.findField(MathHelper.class, "SIN_TABLE", "field_76144_a");
